# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 18:34:05 2017
...
# Esta es al función de la mágica, le pasamos los datos y recorremos caracteristica
...
target(datos)
print(sorted(clasificadas, key=lambda k: k[0]))
graph(clasificadas)